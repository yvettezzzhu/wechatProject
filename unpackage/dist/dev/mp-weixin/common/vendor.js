...
/* 4 */
/*!*******************************************************!*\
  !*** /Users/zhuyuanlan/Documents/前端代码/小程序/pages.json ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 11 */
/*!**************************************************************!*\
  !*** /Users/zhuyuanlan/Documents/前端代码/小程序/common/js/tool.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni, uniCloud) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  getTokenValue: function getTokenValue(options) {//1.获取用户的token
    var
    _success =
  ...
  uniShowToast: function uniShowToast(options) {//2.提升框
    var
    title =
  ...
  isGetLocation: function isGetLocation() {var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "scope.userInfo";var _success2 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;var fail = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null; //3. 判断是否授权
    var _this = this;
    uni.getSetting({
      success: function success(res) {
        if (!res.authSetting[type]) {
          _this.getAuthorizeInfo(type, _success2, fail);
        } else {
  ...
  getAuthorizeInfo: function getAuthorizeInfo(type, _success3, _fail) {//4. 进行授权
    var _this = this;
    uni.authorize({
      scope: type,
      success: function success() {
...
/* 16 */
/*!***********************************************************************!*\
  !*** /Users/zhuyuanlan/Documents/前端代码/小程序/pages.json?{"type":"stat"} ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__F0E5024" };exports.default = _default;
